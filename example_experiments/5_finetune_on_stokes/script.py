...
def parse_args():
    ...
    parser.add_argument('--pretraining_dataset', type=str, help='Name of pretraining dataset')
    parser.add_argument('--dataset', type=str, help='Name of pretraining dataset', required=True)
    parser.add_argument('--pretrained_model_dir', type=str, help='Directory of saved pretrained model')
...
pretraining_dataset_name = args.pretraining_dataset
...
logging.info(f'Finetuning params: dataset {dataset_name}, num_epochs {num_epochs}, ' \
             f'pretrained model {pretrained_model_dir}, {pretraining_dataset_name}')
model = modeling.train_model(model_name='attentive_fp',
                             dataset_name=dataset_name,
                             mode=mode,
                             pretraining_dataset_name=pretraining_dataset_name,
